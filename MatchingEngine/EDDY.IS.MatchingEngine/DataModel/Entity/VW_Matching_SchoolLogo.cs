...
{
    public class VW_Matching_SchoolLogo
    {
        ...
        public VW_Matching_SchoolLogo(IDataReader dr)
        {
            ...
            //if (!dr.IsDBNull(dr.GetOrdinal("HasSchoolLogo")))
            //    HasLogo = (bool)dr.GetValue(dr.GetOrdinal("HasSchoolLogo"));
        }
