...
{
    public class CampusFilter : ActionFilterBase
    {
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            var campusId = requestValues["CampusId"];
            PerformValidation(campusId, ref responseContent);
        ...
        protected virtual void PerformValidation(string campusId, ref VendorResponseBase responseContent)
        {
            if (!string.IsNullOrEmpty(campusId))
            {
                if (this.isInputNotNumeric(campusId))
                {
                    responseContent.MessageCodes.Add(InputValidation.MessageCodes.CampusIdIsNotNumeric);
                }
            }
        }
    }
