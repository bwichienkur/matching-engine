...
{
    public class GetCategoriesResponseModel : VendorResponseBase
    {
        private Categories categories = new Categories();
        private VendorResponseMessages vendorResponseMessages = new VendorResponseMessages();
        public GetCategoriesResponseModel(DirectoryRequest categoriesRequest)
        {
            ...
            VendorAPIList vendorAPIList = categories.GetCategories(categoriesRequest);
            this.Messages = new List<VendorResponseMessage>();
