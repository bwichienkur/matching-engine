...
{
    public class GetInstitutionsResponseModel : VendorResponseBase
    {
        private Institutions institutions = new Institutions();
        private VendorResponseMessages vendorResponseMessages = new VendorResponseMessages();
        public GetInstitutionsResponseModel(DirectoryRequest schoolRequest)
        {
            ...
            VendorAPIList vendorAPIList = institutions.GetInstitutions(schoolRequest);
            this.Messages = new List<VendorResponseMessage>();
