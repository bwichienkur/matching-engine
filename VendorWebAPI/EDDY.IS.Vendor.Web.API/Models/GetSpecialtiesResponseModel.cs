...
{
    public class GetSpecialtiesResponseModel : VendorResponseBase
    {
        private Specialties specialties = new Specialties();
        private VendorResponseMessages vendorResponseMessages = new VendorResponseMessages();
        public GetSpecialtiesResponseModel(DirectoryRequest categoriesRequest)
        {
            ...
            VendorAPIList vendorAPIList = specialties.GetSpecialties(categoriesRequest);
            this.Messages = new List<VendorResponseMessage>();
