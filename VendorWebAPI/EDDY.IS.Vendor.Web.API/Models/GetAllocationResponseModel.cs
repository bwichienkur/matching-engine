...
{
    public class GetAllocationResponseModel : VendorResponseBase
    {
        private Programs programs = new Programs();
        private VendorResponseMessages vendorResponseMessages = new VendorResponseMessages();
        public GetAllocationResponseModel(DirectoryRequest allocationRequest)
        {
            ...
            this.Body = programs.CheckAllocation(allocationRequest);
