...
{
    public class GetLevelsResponseModel : VendorResponseBase
    {
        private Levels levels = new Levels();
        private VendorResponseMessages vendorResponseMessages = new VendorResponseMessages();
        public GetLevelsResponseModel(DirectoryRequest levelsRequest)
        {
            ...
            VendorAPIList vendorAPIList = levels.GetLevels(levelsRequest);
            this.Messages = new List<VendorResponseMessage>();
