...
{
    public class GetSubCategoriesResponseModel : VendorResponseBase
    {
        private Categories categories = new Categories();
        private VendorResponseMessages vendorResponseMessages = new VendorResponseMessages();
        public GetSubCategoriesResponseModel(DirectoryRequest categoriesRequest)
        {
            ...
            VendorAPIList vendorAPIList = categories.GetSubCategories(categoriesRequest);
            this.Messages = new List<VendorResponseMessage>();
