...
{
    public class PostLeadUpdateResponseModel : VendorResponseBase
    {

        private Leads leads = new Leads();
        private VendorResponseMessages vendorResponseMessages = new VendorResponseMessages();
        public PostLeadUpdateResponseModel(LeadUpdateRequest leadUpdateRequest)
        {
            ...
            VendorResponseBase leadSaveResponse = leads.UpdateEMSLead(leadUpdateRequest);
