...
{
    public class PostEduMaxLeadResponseModel : VendorResponseBase
    {
        private Leads leads = new Leads();
        private VendorResponseMessages vendorResponseMessages = new VendorResponseMessages();
        public PostEduMaxLeadResponseModel(ContactRequest contactRequest)
        {
            ...
            VendorResponseBase leadSaveResponse = leads.SaveEduMaxLead(contactRequest);
