(function ($) {
    ...
    function recoverSplitPhoneFields() {
        ...
        if (alternate_phone != "" && alternate_phone != undefined && alternate_phone.length >= 10) {
    ...
    $(document).ready(function () {
        ...
        //Adds HTML to the buttons of the Welkin Theme
        if (FormsEngine.Theme == "welkin") {
            FormsEngine.SubmitButtonLabelTextNormal = 'Next';
            $("#wizard-form-submit-button #next").html("<div id='form-submit-button-label'>Next</div><i class=\"fa fa-arrow-circle-o-right\"></i>");
            $("#form-navback-button #prev").html("<i class=\"fa fa-arrow-circle-o-left\"></i><div class=\"btn-text-holder\">Prev</div>");

            if (FormsEngine.hasOwnProperty("RenderingExperience") && FormsEngine.RenderingExperience == "Prospect") {

                $("#wizard-form-submit-button").addClass("btnNext-prospect");
                $("#wizard-form-submit-button #next").html("<div class=\"btn-text-holder\">Call Me Now</div><i class=\"fa fa-arrow-circle-o-right\"></i>");
