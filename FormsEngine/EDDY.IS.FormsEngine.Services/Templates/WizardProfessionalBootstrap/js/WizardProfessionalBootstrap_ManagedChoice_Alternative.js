(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(FormsEngine.WorkflowManagedChoiceDivTag).find('input[name=ms-us-school-checkbox]').on('change', function (event) {
            if ($(this).is(":checked") && (fe_mc_isOverUserSelectionCount())) {
                $(this).prop("checked", false);
                $(this).parent().find("i.checkbox-icon").removeClass("fa-check-square-o").addClass("fa-square-o");
            }
            else {
                $(this).parent().find("i.checkbox-icon").removeClass("fa-square-o").addClass("fa-check-square-o");
